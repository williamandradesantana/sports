...
import io.github.williamandradesantana.sports.infrastructure.scheduling.match.OddsSyncScheduler;
...
public class SchedulingConfig {
    ...
    @Bean
    public OddsSyncScheduler oddsSyncScheduler(
            SyncOddsUseCase syncOddsUseCase, MatchRepository matchRepository,
            @Value("${app.odds.capture-window-hours}") int captureWindowHours) {
        return new OddsSyncScheduler(syncOddsUseCase, matchRepository, captureWindowHours);
    }
}
